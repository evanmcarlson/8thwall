...
const faceRotationComponent = {
  init() {
    let rot
    const q = new THREE.Quaternion()
    this.el.sceneEl.addEventListener('xrfaceupdated', ({detail}) => {
      rot = detail.transform.rotation
...
export {faceTextureComponent, faceRotationComponent}
