...
import {requiredFeaturesPipelineModule} from './requiredFeatures'
...
const onxrloaded = () => {
  XR8.addCameraPipelineModules([  // Add camera pipeline modules.
    ...
    requiredFeaturesPipelineModule,
  ...
  // sessionConfiguration: {defaultEnvironment: {disabled: true}}
  XR8.run({canvas, allowedDevices: XR8.XrConfig.device().ANY, webgl2: true, sessionConfiguration: {disableXrTablet: true, disableXrTouchEmulation: true, disableCameraReparenting: true}})
}
